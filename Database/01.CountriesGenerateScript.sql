...
CREATE TABLE [Countries] (
    ...
    CONSTRAINT [FK_Countries_Continents] FOREIGN KEY ([ContinentCode]) REFERENCES [Continents] ([ContinentCode])
    );

CREATE NONCLUSTERED INDEX [IX_Countries_Continent_Code]
    ON [Countries] ([ContinentCode]);

INSERT INTO [Countries] ([CountryCode], [ContinentCode], [CountryName], [iso3], [CountryNumber], [CountryFullName]) VALUES
